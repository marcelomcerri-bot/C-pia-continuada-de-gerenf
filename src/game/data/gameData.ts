...
export const NPC_DEFS: NPCDef[] = [
    ...
    dialogues: [
      {
        ...
        choices: [
          ...
          },
          {
            ...
            effect: (s) => ({ prestige: s.prestige + 0 }),
            missionEffect: 'triagem_ps:complete',
          },
          {
    ...
    dialoguePools: [
      ...
      [{
        ...
        choices: [
          ...
          { text: 'O dimensionamento é calculated pela direção hospitalar com base no orçamento disponível.', correct: false, feedback: 'Errado. O COFEN define parâmetros técnicos mínimos que devem ser respeitados independente do orçamento.', effect: (s) => ({ prestige: s.prestige + 0 }) },
        ],
      }],
      [{
        id: 'pool3_carlos',
  ...
  },
  {
    ...
    bodyColor: 0xffffff, coatColor: 0xffffff, hairColor: 0x2c1d11, skinColor: 0xd4a574,
